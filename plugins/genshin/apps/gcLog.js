  ...
  constructor() {
    super({
      ...
      rule: [
        ...
        {
          reg: "^#?(原神|星铁)?(全部)?(抽卡|抽奖|角色|联动角色|武器|联动武器|集录|常驻|up|新手|光锥|联动光锥|全部)池*(记录|祈愿|分析)$",
          fnc: "getLog",
        },
        {
    ...
    Object.defineProperty(this, "button", {
      get() {
        ...
        return segment.button(
          ...
          [
            { text: "联动角色记录", callback: `${this.prefix}联动角色记录` },
            { text: "联动角色统计", callback: `${this.prefix}联动角色统计` },
          ],
          [
            { text: "联动武器记录", callback: `${this.prefix}联动武器记录` },
            { text: "联动武器统计", callback: `${this.prefix}联动武器统计` },
          ],
          [
